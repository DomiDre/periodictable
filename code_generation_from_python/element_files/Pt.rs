...
pub fn load() -> Element {
    Element {
        ...
        neutron_scattering: Some(NeutronScatteringFactor {
            ...
            b_p: None,
            b_m: None,
            coherent_scattering_xs: Some(UncertainFloat::new(11.58_f64, 0.02_f64)),
            incoherent_scattering_xs: Some(UncertainFloat::new(0.13_f64, 0.11_f64)),
            absorption_scattering_xs: Some(UncertainFloat::new(11.71_f64, 0.11_f64)),
            thermal_absorption_xs: Some(UncertainFloat::new(10.3_f64, 0.3_f64)),
        }),
        isotopes: vec![
            Isotope { 
                mass_number: 168,
            ...
            Isotope { 
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    b_p: None,
                    b_m: None,
                    coherent_scattering_xs: Some(UncertainFloat::new(10.0_f64, 2.0_f64)),
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.0, 0.0)),
                    absorption_scattering_xs: Some(UncertainFloat::new(10.0_f64, 2.0_f64)),
                    thermal_absorption_xs: Some(UncertainFloat::new(152.0_f64, 4.0_f64)),
                }),
            },
            Isotope { 
                mass_number: 191,
            ...
            Isotope { 
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    b_p: None,
                    b_m: None,
                    coherent_scattering_xs: Some(UncertainFloat::new(12.3_f64, 1.2_f64)),
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.0, 0.0)),
                    absorption_scattering_xs: Some(UncertainFloat::new(12.3_f64, 1.2_f64)),
                    thermal_absorption_xs: Some(UncertainFloat::new(10.0_f64, 2.5_f64)),
                }),
            },
            Isotope { 
                mass_number: 193,
            ...
            Isotope { 
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    b_p: None,
                    b_m: None,
                    coherent_scattering_xs: Some(UncertainFloat::new(14.0_f64, 0.2_f64)),
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.0, 0.0)),
                    absorption_scattering_xs: Some(UncertainFloat::new(14.0_f64, 0.2_f64)),
                    thermal_absorption_xs: Some(UncertainFloat::new(1.44_f64, 0.19_f64)),
                }),
            },
            Isotope { 
                mass_number: 195,
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    coherent_scattering_xs: Some(UncertainFloat::new(9.8_f64, 0.2_f64)),
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.13_f64, 0.04_f64)),
                    absorption_scattering_xs: Some(UncertainFloat::new(9.9_f64, 0.2_f64)),
                    thermal_absorption_xs: Some(UncertainFloat::new(27.5_f64, 1.2_f64)),
                }),
            },
            Isotope { 
                mass_number: 196,
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    b_p: None,
                    b_m: None,
                    coherent_scattering_xs: Some(UncertainFloat::new(12.3_f64, 0.2_f64)),
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.0, 0.0)),
                    absorption_scattering_xs: Some(UncertainFloat::new(12.3_f64, 0.2_f64)),
                    thermal_absorption_xs: Some(UncertainFloat::new(0.72_f64, 0.04_f64)),
                }),
            },
            Isotope { 
                mass_number: 197,
            ...
            Isotope { 
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    b_p: None,
                    b_m: None,
                    coherent_scattering_xs: Some(UncertainFloat::new(7.6_f64, 0.2_f64)),
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.0, 0.0)),
                    absorption_scattering_xs: Some(UncertainFloat::new(7.6_f64, 0.2_f64)),
                    thermal_absorption_xs: Some(UncertainFloat::new(3.66_f64, 0.19_f64)),
                }),
            },
            Isotope { 
                mass_number: 199,
