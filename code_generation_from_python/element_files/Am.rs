...
pub fn load() -> Element {
    Element {
        ...
        neutron_scattering: Some(NeutronScatteringFactor {
            ...
            b_p: None,
            b_m: None,
            coherent_scattering_xs: Some(UncertainFloat::new(8.7_f64, 0.4_f64)),
            incoherent_scattering_xs: Some(UncertainFloat::new(0.3_f64, 2.6_f64)),
            absorption_scattering_xs: Some(UncertainFloat::new(9.0_f64, 2.6_f64)),
            thermal_absorption_xs: Some(UncertainFloat::new(75.3_f64, 1.8_f64)),
        }),
        isotopes: vec![
            Isotope { 
                mass_number: 231,
            ...
            Isotope { 
                mass_number: 237,
                mass: UncertainFloat::new(237.049_970_f64, 0.000_060_f64),
                abundance: UncertainFloat::new(0.0, 0.0),
                xray_scattering: None,
                neutron_scattering: None
            },
            Isotope { 
                mass_number: 238,
                mass: UncertainFloat::new(238.051_980_f64, 0.000_050_f64),
                abundance: UncertainFloat::new(0.0, 0.0),
                xray_scattering: None,
                neutron_scattering: None
            },
            ...
            Isotope { 
                mass_number: 242,
                mass: UncertainFloat::new(242.059_543_0_f64, 0.000_002_1_f64),
                abundance: UncertainFloat::new(0.0, 0.0),
                xray_scattering: None,
                neutron_scattering: None
            },
