...
pub fn load() -> Element {
    Element {
        ...
        neutron_scattering: Some(NeutronScatteringFactor {
            ...
            b_p: None,
            b_m: None,
            coherent_scattering_xs: Some(UncertainFloat::new(7.485_f64, 0.008_f64)),
            incoherent_scattering_xs: Some(UncertainFloat::new(0.55_f64, 0.03_f64)),
            absorption_scattering_xs: Some(UncertainFloat::new(8.03_f64, 0.03_f64)),
            thermal_absorption_xs: Some(UncertainFloat::new(3.78_f64, 0.02_f64)),
        }),
        isotopes: vec![
            Isotope { 
                mass_number: 52,
            ...
            Isotope { 
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    b_p: None,
                    b_m: None,
                    coherent_scattering_xs: Some(UncertainFloat::new(5.2_f64, 0.2_f64)),
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.006_f64, 0.001_f64)),
                    absorption_scattering_xs: Some(UncertainFloat::new(5.2_f64, 0.2_f64)),
                    thermal_absorption_xs: Some(UncertainFloat::new(4.50_f64, 0.02_f64)),
                }),
            },
            Isotope { 
                mass_number: 64,
            ...
            Isotope { 
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.40_f64, 0.04_f64)),
                    absorption_scattering_xs: Some(UncertainFloat::new(14.5_f64, 0.5_f64)),
                    thermal_absorption_xs: Some(UncertainFloat::new(2.17_f64, 0.03_f64)),
                }),
            },
            Isotope { 
                mass_number: 66,
