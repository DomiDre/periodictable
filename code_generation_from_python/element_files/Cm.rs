...
pub fn load() -> Element {
    Element {
        ...
        neutron_scattering: Some(NeutronScatteringFactor {
            ...
            b_p: None,
            b_m: None,
            coherent_scattering_xs: Some(UncertainFloat::new(11.3_f64, 0.7_f64)),
            incoherent_scattering_xs: Some(UncertainFloat::new(0.0, 0.0)),
            absorption_scattering_xs: Some(UncertainFloat::new(11.3_f64, 0.7_f64)),
            thermal_absorption_xs: Some(UncertainFloat::new(16.2_f64, 1.2_f64)),
        }),
        isotopes: vec![
            Isotope { 
                mass_number: 233,
                mass: UncertainFloat::new(233.050_80_f64, 0.000_43_f64),
            ...
            Isotope { 
                mass_number: 238,
                mass: UncertainFloat::new(238.053_020_f64, 0.000_040_f64),
                abundance: UncertainFloat::new(0.0, 0.0),
                xray_scattering: None,
                neutron_scattering: None
            },
            ...
            Isotope { 
                mass_number: 240,
                mass: UncertainFloat::new(240.055_519_0_f64, 0.000_002_9_f64),
                abundance: UncertainFloat::new(0.0, 0.0),
                xray_scattering: None,
                neutron_scattering: None
            },
            ...
            Isotope { 
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    b_p: None,
                    b_m: None,
                    coherent_scattering_xs: Some(UncertainFloat::new(10.9_f64, 0.5_f64)),
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.0, 0.0)),
                    absorption_scattering_xs: Some(UncertainFloat::new(10.9_f64, 0.5_f64)),
                    thermal_absorption_xs: Some(UncertainFloat::new(1.36_f64, 0.17_f64)),
                }),
            },
            Isotope { 
                mass_number: 247,
            ...
            Isotope { 
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    b_p: None,
                    b_m: None,
                    coherent_scattering_xs: Some(UncertainFloat::new(7.5_f64, 0.4_f64)),
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.0, 0.0)),
                    absorption_scattering_xs: Some(UncertainFloat::new(7.5_f64, 0.4_f64)),
                    thermal_absorption_xs: Some(UncertainFloat::new(3.00_f64, 0.26_f64)),
                }),
            },
            Isotope { 
                mass_number: 249,
