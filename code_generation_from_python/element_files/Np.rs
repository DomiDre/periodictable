...
pub fn load() -> Element {
    Element {
        ...
        neutron_scattering: Some(NeutronScatteringFactor {
            ...
            b_p: None,
            b_m: None,
            coherent_scattering_xs: Some(UncertainFloat::new(14.0_f64, 0.3_f64)),
            incoherent_scattering_xs: Some(UncertainFloat::new(0.5_f64, 0.5_f64)),
            absorption_scattering_xs: Some(UncertainFloat::new(14.5_f64, 0.6_f64)),
            thermal_absorption_xs: Some(UncertainFloat::new(175.9_f64, 2.9_f64)),
        }),
        isotopes: vec![
            Isotope { 
                mass_number: 225,
