...
pub fn load() -> Element {
    Element {
        ...
        neutron_scattering: Some(NeutronScatteringFactor {
            ...
            b_p: None,
            b_m: None,
            coherent_scattering_xs: Some(UncertainFloat::new(4.871_f64, 0.003_f64)),
            incoherent_scattering_xs: Some(UncertainFloat::new(0.022_f64, 0.005_f64)),
            absorption_scattering_xs: Some(UncertainFloat::new(4.892_f64, 0.006_f64)),
            thermal_absorption_xs: Some(UncertainFloat::new(0.626_f64, 0.009_f64)),
        }),
        isotopes: vec![
            Isotope { 
                mass_number: 100,
            ...
            Isotope { 
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    thermal_absorption_xs: Some(UncertainFloat::new(1.00_f64, 0.11_f64)),
                }),
            },
            Isotope { 
                mass_number: 113,
            ...
            Isotope { 
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    b_p: None,
                    b_m: None,
                    coherent_scattering_xs: Some(UncertainFloat::new(4.8_f64, 0.5_f64)),
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.0, 0.0)),
                    absorption_scattering_xs: Some(UncertainFloat::new(4.8_f64, 0.5_f64)),
                    thermal_absorption_xs: Some(UncertainFloat::new(0.114_f64, 0.030_f64)),
                }),
            },
            Isotope { 
                mass_number: 115,
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    absorption_scattering_xs: Some(UncertainFloat::new(4.8_f64, 1.5_f64)),
                    thermal_absorption_xs: Some(UncertainFloat::new(30.0_f64, 7.0_f64)),
                }),
            },
            Isotope { 
                mass_number: 116,
                ...
                xray_scattering: None,
                neutron_scattering: Some(NeutronScatteringFactor {
                    b_c: UncertainFloat::new(6.10_f64, 0.01_f64),
                    b_p: None,
                    b_m: None,
                    coherent_scattering_xs: Some(UncertainFloat::new(4.42_f64, 0.07_f64)),
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.0, 0.0)),
                    absorption_scattering_xs: Some(UncertainFloat::new(4.42_f64, 0.07_f64)),
                    thermal_absorption_xs: Some(UncertainFloat::new(0.14_f64, 0.03_f64)),
                }),
            },
            Isotope { 
                mass_number: 117,
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    coherent_scattering_xs: Some(UncertainFloat::new(5.28_f64, 0.08_f64)),
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.3_f64, 0.3_f64)),
                    absorption_scattering_xs: Some(UncertainFloat::new(5.6_f64, 0.3_f64)),
                    thermal_absorption_xs: Some(UncertainFloat::new(2.3_f64, 0.5_f64)),
                }),
            },
            Isotope { 
                mass_number: 118,
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    b_p: None,
                    b_m: None,
                    coherent_scattering_xs: Some(UncertainFloat::new(4.63_f64, 0.08_f64)),
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.0, 0.0)),
                    absorption_scattering_xs: Some(UncertainFloat::new(4.63_f64, 0.08_f64)),
                    thermal_absorption_xs: Some(UncertainFloat::new(0.22_f64, 0.05_f64)),
                }),
            },
            Isotope { 
                mass_number: 119,
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    coherent_scattering_xs: Some(UncertainFloat::new(4.71_f64, 0.08_f64)),
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.3_f64, 0.3_f64)),
                    absorption_scattering_xs: Some(UncertainFloat::new(5.0_f64, 0.3_f64)),
            ...
            Isotope { 
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    b_p: None,
                    b_m: None,
                    coherent_scattering_xs: Some(UncertainFloat::new(5.29_f64, 0.08_f64)),
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.0, 0.0)),
                    absorption_scattering_xs: Some(UncertainFloat::new(5.29_f64, 0.08_f64)),
                    thermal_absorption_xs: Some(UncertainFloat::new(0.14_f64, 0.03_f64)),
                }),
            },
            Isotope { 
            ...
            Isotope { 
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    b_p: None,
                    b_m: None,
                    coherent_scattering_xs: Some(UncertainFloat::new(4.14_f64, 0.07_f64)),
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.0, 0.0)),
                    absorption_scattering_xs: Some(UncertainFloat::new(4.14_f64, 0.07_f64)),
                    thermal_absorption_xs: Some(UncertainFloat::new(0.18_f64, 0.02_f64)),
                }),
            },
            Isotope { 
                mass_number: 123,
            ...
            Isotope { 
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    thermal_absorption_xs: Some(UncertainFloat::new(0.133_f64, 0.005_f64)),
                }),
            },
            Isotope { 
                mass_number: 125,
