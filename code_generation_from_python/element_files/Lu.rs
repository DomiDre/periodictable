...
pub fn load() -> Element {
    Element {
        ...
        neutron_scattering: Some(NeutronScatteringFactor {
            ...
            b_p: None,
            b_m: None,
            coherent_scattering_xs: Some(UncertainFloat::new(6.53_f64, 0.05_f64)),
            incoherent_scattering_xs: Some(UncertainFloat::new(0.7_f64, 0.4_f64)),
            absorption_scattering_xs: Some(UncertainFloat::new(7.2_f64, 0.4_f64)),
            thermal_absorption_xs: Some(UncertainFloat::new(74.0_f64, 2.0_f64)),
        }),
        isotopes: vec![
            Isotope { 
                mass_number: 150,
            ...
            Isotope { 
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    b_p: None,
                    b_m: None,
                    coherent_scattering_xs: Some(UncertainFloat::new(6.59_f64, 0.05_f64)),
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.6_f64, 0.4_f64)),
                    absorption_scattering_xs: Some(UncertainFloat::new(7.2_f64, 0.4_f64)),
                    thermal_absorption_xs: Some(UncertainFloat::new(21.0_f64, 3.0_f64)),
                }),
            },
            Isotope { 
                mass_number: 176,
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    b_p: None,
                    b_m: None,
                    coherent_scattering_xs: Some(UncertainFloat::new(4.7_f64, 0.2_f64)),
                    incoherent_scattering_xs: Some(UncertainFloat::new(1.2_f64, 0.3_f64)),
                    absorption_scattering_xs: Some(UncertainFloat::new(5.9, 0.0)),
                    thermal_absorption_xs: Some(UncertainFloat::new(2065._f64, 35._f64)),
                }),
            },
            Isotope { 
                mass_number: 177,
