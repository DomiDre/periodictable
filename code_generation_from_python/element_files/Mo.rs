...
pub fn load() -> Element {
    Element {
        ...
        neutron_scattering: Some(NeutronScatteringFactor {
            ...
            b_p: None,
            b_m: None,
            coherent_scattering_xs: Some(UncertainFloat::new(5.67_f64, 0.03_f64)),
            incoherent_scattering_xs: Some(UncertainFloat::new(0.04_f64, 0.05_f64)),
            absorption_scattering_xs: Some(UncertainFloat::new(5.71_f64, 0.04_f64)),
            thermal_absorption_xs: Some(UncertainFloat::new(2.48_f64, 0.04_f64)),
        }),
        isotopes: vec![
            Isotope { 
                mass_number: 83,
            ...
            Isotope { 
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    b_p: None,
                    b_m: None,
                    coherent_scattering_xs: Some(UncertainFloat::new(6.00_f64, 0.14_f64)),
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.0, 0.0)),
                    absorption_scattering_xs: Some(UncertainFloat::new(6.00_f64, 0.14_f64)),
                    thermal_absorption_xs: Some(UncertainFloat::new(0.019_f64, 0.002_f64)),
                }),
            },
            Isotope { 
                mass_number: 93,
            ...
            Isotope { 
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    b_p: None,
                    b_m: None,
                    coherent_scattering_xs: Some(UncertainFloat::new(5.81_f64, 0.12_f64)),
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.0, 0.0)),
                    absorption_scattering_xs: Some(UncertainFloat::new(5.81_f64, 0.12_f64)),
                    thermal_absorption_xs: Some(UncertainFloat::new(0.015_f64, 0.002_f64)),
                }),
            },
            Isotope { 
                mass_number: 95,
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    b_p: None,
                    b_m: None,
                    coherent_scattering_xs: Some(UncertainFloat::new(6.00_f64, 0.10_f64)),
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.5_f64, 0.5_f64)),
                    absorption_scattering_xs: Some(UncertainFloat::new(6.5_f64, 0.5_f64)),
            ...
            Isotope { 
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    b_p: None,
                    b_m: None,
                    coherent_scattering_xs: Some(UncertainFloat::new(4.83_f64, 0.09_f64)),
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.0, 0.0)),
                    absorption_scattering_xs: Some(UncertainFloat::new(4.83_f64, 0.09_f64)),
                    thermal_absorption_xs: Some(UncertainFloat::new(0.5_f64, 0.2_f64)),
                }),
            },
            Isotope { 
                mass_number: 97,
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    b_p: None,
                    b_m: None,
                    coherent_scattering_xs: Some(UncertainFloat::new(6.59_f64, 0.15_f64)),
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.5_f64, 0.5_f64)),
                    absorption_scattering_xs: Some(UncertainFloat::new(7.1_f64, 0.5_f64)),
            ...
            Isotope { 
                ...
                xray_scattering: None,
                neutron_scattering: Some(NeutronScatteringFactor {
                    b_c: UncertainFloat::new(6.60_f64, 0.07_f64),
                    b_p: None,
                    b_m: None,
                    coherent_scattering_xs: Some(UncertainFloat::new(5.44_f64, 0.12_f64)),
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.0, 0.0)),
                    absorption_scattering_xs: Some(UncertainFloat::new(5.44_f64, 0.12_f64)),
                    thermal_absorption_xs: Some(UncertainFloat::new(0.127_f64, 0.006_f64)),
                }),
            },
            Isotope { 
                mass_number: 99,
            ...
            Isotope { 
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    b_p: None,
                    b_m: None,
                    coherent_scattering_xs: Some(UncertainFloat::new(5.69_f64, 0.12_f64)),
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.0, 0.0)),
                    absorption_scattering_xs: Some(UncertainFloat::new(5.69_f64, 0.12_f64)),
