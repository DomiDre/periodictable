...
pub fn load() -> Element {
    Element {
        ...
        isotopes: vec![
            ...
            Isotope { 
                mass_number: 246,
                mass: UncertainFloat::new(246.068_670_f64, 0.000_060_f64),
                abundance: UncertainFloat::new(0.0, 0.0),
                xray_scattering: None,
                neutron_scattering: None
            },
            ...
            Isotope { 
                mass_number: 248,
                mass: UncertainFloat::new(248.073_080_f64, 0.000_080_f64),
                abundance: UncertainFloat::new(0.0, 0.0),
                xray_scattering: None,
                neutron_scattering: None
            },
            Isotope { 
                mass_number: 249,
                mass: UncertainFloat::new(249.074_980_f64, 0.000_003_f64),
                abundance: UncertainFloat::new(0.0, 0.0),
                xray_scattering: None,
                neutron_scattering: None
            },
            ...
            Isotope { 
                mass_number: 252,
                mass: UncertainFloat::new(252.084_30_f64, 0.000_22_f64),
                abundance: UncertainFloat::new(0.0, 0.0),
                xray_scattering: None,
                neutron_scattering: None
            },
            ...
            Isotope { 
                mass_number: 254,
                mass: UncertainFloat::new(254.090_60_f64, 0.000_32_f64),
                abundance: UncertainFloat::new(0.0, 0.0),
                xray_scattering: None,
                neutron_scattering: None
            },
