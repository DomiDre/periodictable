...
pub fn load() -> Element {
    Element {
        ...
        neutron_scattering: Some(NeutronScatteringFactor {
            ...
            coherent_scattering_xs: Some(UncertainFloat::new(19.0_f64, 0.3_f64)),
            incoherent_scattering_xs: Some(UncertainFloat::new(4.5_f64, 0.3_f64)),
            absorption_scattering_xs: Some(UncertainFloat::new(23.5_f64, 0.6_f64)),
            thermal_absorption_xs: Some(UncertainFloat::new(27.5_f64, 0.2_f64)),
        }),
        isotopes: vec![
            Isotope { 
                mass_number: 36,
