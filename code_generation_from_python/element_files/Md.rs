        ...
        Element {
            ...
            isotopes:
                vec![
                    ...
                    Isotope { 
                        mass_number: 247,
                        mass: UncertainFloat::new(247.081_80_f64, 0.000_39_f64),
                        abundance: UncertainFloat::new(0.0, 0.0),
                        b_coherent: 
                    },
                    Isotope { 
                    ...
                    Isotope { 
                        mass_number: 249,
                        mass: UncertainFloat::new(249.083_00_f64, 0.000_24_f64),
                        abundance: UncertainFloat::new(0.0, 0.0),
                        b_coherent: 
                    },
                    Isotope { 
                    ...
                    Isotope { 
                        mass_number: 256,
                        mass: UncertainFloat::new(256.094_050_f64, 0.000_060_f64),
                        abundance: UncertainFloat::new(0.0, 0.0),
                        b_coherent: 
                    },
                    Isotope { 
                    ...
                    Isotope { 
                        mass_number: 259,
                        mass: UncertainFloat::new(259.100_50_f64, 0.000_22_f64),
                        abundance: UncertainFloat::new(0.0, 0.0),
                        b_coherent: 
                    },
                    Isotope { 
