...
pub fn load() -> Element {
    Element {
        ...
        neutron_scattering: Some(NeutronScatteringFactor {
            ...
            b_m: Some(UncertainFloat::new(-1.00_f64, 0.06_f64)),
            coherent_scattering_xs: Some(UncertainFloat::new(1.66_f64, 0.02_f64)),
            incoherent_scattering_xs: Some(UncertainFloat::new(1.62_f64, 0.03_f64)),
            absorption_scattering_xs: Some(UncertainFloat::new(3.28_f64, 0.04_f64)),
            thermal_absorption_xs: Some(UncertainFloat::new(0.530_f64, 0.005_f64)),
        }),
        isotopes: vec![
            Isotope { 
                mass_number: 18,
