...
pub fn load() -> Element {
    Element {
        ...
        neutron_scattering: Some(NeutronScatteringFactor {
            ...
            b_p: None,
            b_m: None,
            coherent_scattering_xs: Some(UncertainFloat::new(2.08_f64, 0.02_f64)),
            incoherent_scattering_xs: Some(UncertainFloat::new(0.54_f64, 0.11_f64)),
            absorption_scattering_xs: Some(UncertainFloat::new(2.62_f64, 0.11_f64)),
            thermal_absorption_xs: Some(UncertainFloat::new(193.8_f64, 1.5_f64)),
        }),
        isotopes: vec![
            Isotope { 
                mass_number: 98,
            ...
            Isotope { 
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    b_p: None,
                    b_m: None,
                    coherent_scattering_xs: Some(UncertainFloat::new(3.65_f64, 0.08_f64)),
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.000_037_f64, 0.000_005_f64)),
                    absorption_scattering_xs: Some(UncertainFloat::new(3.65_f64, 0.08_f64)),
                    thermal_absorption_xs: Some(UncertainFloat::new(12.0_f64, 1.1_f64)),
                }),
            },
            Isotope { 
                mass_number: 114,
            ...
            Isotope { 
                ...
                xray_scattering: None,
                neutron_scattering: Some(NeutronScatteringFactor {
                    b_c: UncertainFloat::new(4.00_f64, 0.03_f64),
                    b_p: Some(UncertainFloat::new(2.1_f64, 0.1_f64)),
                    b_m: Some(UncertainFloat::new(6.4_f64, 0.4_f64)),
                    coherent_scattering_xs: Some(UncertainFloat::new(2.02_f64, 0.02_f64)),
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.55_f64, 0.11_f64)),
                    absorption_scattering_xs: Some(UncertainFloat::new(2.57_f64, 0.11_f64)),
                    thermal_absorption_xs: Some(UncertainFloat::new(202.0_f64, 2.0_f64)),
                }),
            },
            Isotope { 
                mass_number: 116,
