...
pub fn load() -> Element {
    Element {
        ...
        neutron_scattering: Some(NeutronScatteringFactor {
            ...
            coherent_scattering_xs: Some(UncertainFloat::new(7.55_f64, 0.04_f64)),
            incoherent_scattering_xs: Some(UncertainFloat::new(0.15_f64, 0.08_f64)),
            absorption_scattering_xs: Some(UncertainFloat::new(7.70_f64, 0.09_f64)),
            thermal_absorption_xs: Some(UncertainFloat::new(1.28_f64, 0.02_f64)),
        }),
        isotopes: vec![
            Isotope { 
                mass_number: 77,
