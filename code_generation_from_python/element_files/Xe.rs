...
pub fn load() -> Element {
    Element {
        ...
        neutron_scattering: Some(NeutronScatteringFactor {
            ...
            b_p: None,
            b_m: None,
            coherent_scattering_xs: Some(UncertainFloat::new(3.04_f64, 0.04_f64)),
            incoherent_scattering_xs: Some(UncertainFloat::new(0.0, 0.0)),
            absorption_scattering_xs: None,
            thermal_absorption_xs: Some(UncertainFloat::new(23.9_f64, 1.2_f64)),
        }),
        isotopes: vec![
            Isotope { 
                mass_number: 110,
            ...
            Isotope { 
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.0, 0.0)),
                    absorption_scattering_xs: None,
                    thermal_absorption_xs: Some(UncertainFloat::new(165.0_f64, 20.0_f64)),
                }),
            },
            Isotope { 
                mass_number: 125,
            ...
            Isotope { 
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.0, 0.0)),
                    absorption_scattering_xs: None,
                    thermal_absorption_xs: Some(UncertainFloat::new(3.5_f64, 0.8_f64)),
                }),
            },
            Isotope { 
                mass_number: 127,
            ...
            Isotope { 
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    absorption_scattering_xs: None,
                    thermal_absorption_xs: Some(UncertainFloat::new(21.0_f64, 5.0_f64)),
                }),
            },
            Isotope { 
                mass_number: 130,
            ...
            Isotope { 
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    incoherent_scattering_xs: None,
                    absorption_scattering_xs: None,
                    thermal_absorption_xs: Some(UncertainFloat::new(85.0_f64, 10.0_f64)),
                }),
            },
            Isotope { 
                mass_number: 132,
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.0, 0.0)),
                    absorption_scattering_xs: None,
                    thermal_absorption_xs: Some(UncertainFloat::new(0.45_f64, 0.06_f64)),
                }),
            },
            Isotope { 
                mass_number: 133,
            ...
            Isotope { 
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.0, 0.0)),
                    absorption_scattering_xs: None,
                    thermal_absorption_xs: Some(UncertainFloat::new(0.265_f64, 0.020_f64)),
                }),
            },
            Isotope { 
                mass_number: 135,
            ...
            Isotope { 
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.0, 0.0)),
                    absorption_scattering_xs: None,
                    thermal_absorption_xs: Some(UncertainFloat::new(0.26_f64, 0.02_f64)),
                }),
            },
            Isotope { 
                mass_number: 137,
