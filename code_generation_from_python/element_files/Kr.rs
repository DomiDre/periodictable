...
pub fn load() -> Element {
    Element {
        ...
        neutron_scattering: Some(NeutronScatteringFactor {
            ...
            b_p: None,
            b_m: None,
            coherent_scattering_xs: Some(UncertainFloat::new(7.67_f64, 0.04_f64)),
            incoherent_scattering_xs: Some(UncertainFloat::new(0.01_f64, 0.14_f64)),
            absorption_scattering_xs: Some(UncertainFloat::new(7.68_f64, 0.13_f64)),
            thermal_absorption_xs: Some(UncertainFloat::new(25.0_f64, 1.0_f64)),
        }),
        isotopes: vec![
            Isotope { 
                mass_number: 69,
            ...
            Isotope { 
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    thermal_absorption_xs: Some(UncertainFloat::new(6.4_f64, 0.9_f64)),
                }),
            },
            Isotope { 
                mass_number: 79,
            ...
            Isotope { 
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.0, 0.0)),
                    absorption_scattering_xs: None,
                    thermal_absorption_xs: Some(UncertainFloat::new(11.8_f64, 0.5_f64)),
                }),
            },
            Isotope { 
                mass_number: 81,
            ...
            Isotope { 
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.0, 0.0)),
                    absorption_scattering_xs: None,
                    thermal_absorption_xs: Some(UncertainFloat::new(29.0_f64, 20.0_f64)),
                }),
            },
            Isotope { 
                mass_number: 83,
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    absorption_scattering_xs: None,
                    thermal_absorption_xs: Some(UncertainFloat::new(185.0_f64, 30.0_f64)),
                }),
            },
            Isotope { 
                mass_number: 84,
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    coherent_scattering_xs: None,
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.0, 0.0)),
                    absorption_scattering_xs: Some(UncertainFloat::new(6.6, 0.0)),
                    thermal_absorption_xs: Some(UncertainFloat::new(0.113_f64, 0.015_f64)),
                }),
            },
            Isotope { 
                mass_number: 85,
            ...
            Isotope { 
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    b_p: None,
                    b_m: None,
                    coherent_scattering_xs: Some(UncertainFloat::new(8.2_f64, 0.4_f64)),
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.0, 0.0)),
                    absorption_scattering_xs: Some(UncertainFloat::new(8.2_f64, 0.4_f64)),
                    thermal_absorption_xs: Some(UncertainFloat::new(0.003_f64, 0.002_f64)),
                }),
            },
            Isotope { 
                mass_number: 87,
