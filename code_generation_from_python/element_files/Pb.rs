...
pub fn load() -> Element {
    Element {
        ...
        neutron_scattering: Some(NeutronScatteringFactor {
            ...
            b_p: None,
            b_m: None,
            coherent_scattering_xs: Some(UncertainFloat::new(11.115_f64, 0.007_f64)),
            incoherent_scattering_xs: Some(UncertainFloat::new(0.003_0_f64, 0.000_7_f64)),
            absorption_scattering_xs: Some(UncertainFloat::new(11.118_f64, 0.007_f64)),
            thermal_absorption_xs: Some(UncertainFloat::new(0.171_f64, 0.002_f64)),
        }),
        isotopes: vec![
            Isotope { 
                mass_number: 181,
            ...
            Isotope { 
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    thermal_absorption_xs: Some(UncertainFloat::new(0.65_f64, 0.07_f64)),
                }),
            },
            Isotope { 
                mass_number: 205,
            ...
            Isotope { 
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    b_p: None,
                    b_m: None,
                    coherent_scattering_xs: Some(UncertainFloat::new(10.68_f64, 0.12_f64)),
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.0, 0.0)),
                    absorption_scattering_xs: Some(UncertainFloat::new(10.68_f64, 0.12_f64)),
                    thermal_absorption_xs: Some(UncertainFloat::new(0.030_0_f64, 0.000_8_f64)),
                }),
            },
            Isotope { 
                mass_number: 207,
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    b_p: None,
                    b_m: None,
                    coherent_scattering_xs: Some(UncertainFloat::new(10.82_f64, 0.09_f64)),
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.002_f64, 0.002_f64)),
                    absorption_scattering_xs: Some(UncertainFloat::new(10.82_f64, 0.09_f64)),
                    thermal_absorption_xs: Some(UncertainFloat::new(0.699_f64, 0.010_f64)),
                }),
            },
            Isotope { 
                mass_number: 208,
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    b_p: None,
                    b_m: None,
                    coherent_scattering_xs: Some(UncertainFloat::new(11.34_f64, 0.05_f64)),
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.0, 0.0)),
                    absorption_scattering_xs: Some(UncertainFloat::new(11.34_f64, 0.05_f64)),
                    thermal_absorption_xs: Some(UncertainFloat::new(0.000_48_f64, 0.000_03_f64)),
                }),
            },
            Isotope { 
                mass_number: 209,
