...
pub fn load() -> Element {
    Element {
        ...
        neutron_scattering: Some(NeutronScatteringFactor {
            ...
            b_p: None,
            b_m: None,
            coherent_scattering_xs: Some(UncertainFloat::new(7.5_f64, 0.2_f64)),
            incoherent_scattering_xs: Some(UncertainFloat::new(0.2_f64, 0.6_f64)),
            absorption_scattering_xs: Some(UncertainFloat::new(7.7_f64, 0.6_f64)),
            thermal_absorption_xs: Some(UncertainFloat::new(1017.3_f64, 2.1_f64)),
        }),
        isotopes: vec![
            Isotope { 
                mass_number: 228,
                mass: UncertainFloat::new(228.038_730_f64, 0.000_030_f64),
            ...
            Isotope { 
                mass_number: 229,
                mass: UncertainFloat::new(229.040_140_f64, 0.000_080_f64),
                abundance: UncertainFloat::new(0.0, 0.0),
                xray_scattering: None,
                neutron_scattering: None
            },
            ...
            Isotope { 
                mass_number: 233,
                mass: UncertainFloat::new(233.042_990_f64, 0.000_050_f64),
                abundance: UncertainFloat::new(0.0, 0.0),
                xray_scattering: None,
                neutron_scattering: None
            },
            ...
            Isotope { 
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    b_p: None,
                    b_m: None,
                    coherent_scattering_xs: Some(UncertainFloat::new(1.54_f64, 0.09_f64)),
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.0, 0.0)),
                    absorption_scattering_xs: Some(UncertainFloat::new(1.54_f64, 0.09_f64)),
                    thermal_absorption_xs: Some(UncertainFloat::new(289.6_f64, 1.4_f64)),
                }),
            },
            Isotope { 
                mass_number: 241,
            ...
            Isotope { 
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    b_p: None,
                    b_m: None,
                    coherent_scattering_xs: Some(UncertainFloat::new(8.2_f64, 0.2_f64)),
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.0, 0.0)),
                    absorption_scattering_xs: Some(UncertainFloat::new(8.2_f64, 0.2_f64)),
                    thermal_absorption_xs: Some(UncertainFloat::new(18.5_f64, 0.5_f64)),
                }),
            },
            Isotope { 
                mass_number: 243,
