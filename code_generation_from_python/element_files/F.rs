...
pub fn load() -> Element {
    Element {
        ...
        neutron_scattering: Some(NeutronScatteringFactor {
            ...
            coherent_scattering_xs: Some(UncertainFloat::new(4.017_f64, 0.014_f64)),
            incoherent_scattering_xs: Some(UncertainFloat::new(0.000_8_f64, 0.000_2_f64)),
            absorption_scattering_xs: Some(UncertainFloat::new(4.018_f64, 0.014_f64)),
            thermal_absorption_xs: Some(UncertainFloat::new(0.009_6_f64, 0.000_5_f64)),
        }),
        isotopes: vec![
            Isotope { 
                mass_number: 14,
