...
pub fn load() -> Element {
    Element {
        ...
        neutron_scattering: Some(NeutronScatteringFactor {
            ...
            coherent_scattering_xs: Some(UncertainFloat::new(5.44_f64, 0.02_f64)),
            incoherent_scattering_xs: Some(UncertainFloat::new(0.060_f64, 0.010_f64)),
            absorption_scattering_xs: Some(UncertainFloat::new(5.50_f64, 0.02_f64)),
            thermal_absorption_xs: Some(UncertainFloat::new(4.5_f64, 0.1_f64)),
        }),
        isotopes: vec![
            Isotope { 
                mass_number: 60,
