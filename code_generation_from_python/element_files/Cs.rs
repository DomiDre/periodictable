...
pub fn load() -> Element {
    Element {
        ...
        neutron_scattering: Some(NeutronScatteringFactor {
            ...
            b_p: None,
            b_m: None,
            coherent_scattering_xs: Some(UncertainFloat::new(3.69_f64, 0.15_f64)),
            incoherent_scattering_xs: Some(UncertainFloat::new(0.21_f64, 0.05_f64)),
            absorption_scattering_xs: Some(UncertainFloat::new(3.90_f64, 0.06_f64)),
            thermal_absorption_xs: Some(UncertainFloat::new(29.0_f64, 1.5_f64)),
        }),
        isotopes: vec![
            Isotope { 
                mass_number: 112,
