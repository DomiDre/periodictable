...
pub fn load() -> Element {
    Element {
        ...
        neutron_scattering: Some(NeutronScatteringFactor {
            ...
            b_p: None,
            b_m: None,
            coherent_scattering_xs: Some(UncertainFloat::new(13.0_f64, 3.0_f64)),
            incoherent_scattering_xs: Some(UncertainFloat::new(0.0, 0.0)),
            absorption_scattering_xs: Some(UncertainFloat::new(13.0_f64, 3.0_f64)),
            thermal_absorption_xs: Some(UncertainFloat::new(12.8_f64, 1.5_f64)),
        }),
        isotopes: vec![
            Isotope { 
                mass_number: 203,
