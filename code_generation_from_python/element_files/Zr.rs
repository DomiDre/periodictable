...
pub fn load() -> Element {
    Element {
        ...
        neutron_scattering: Some(NeutronScatteringFactor {
            ...
            b_p: None,
            b_m: None,
            coherent_scattering_xs: Some(UncertainFloat::new(6.44_f64, 0.05_f64)),
            incoherent_scattering_xs: Some(UncertainFloat::new(0.02_f64, 0.15_f64)),
            absorption_scattering_xs: Some(UncertainFloat::new(6.46_f64, 0.14_f64)),
            thermal_absorption_xs: Some(UncertainFloat::new(0.185_f64, 0.003_f64)),
        }),
        isotopes: vec![
            Isotope { 
                mass_number: 79,
            ...
            Isotope { 
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    thermal_absorption_xs: Some(UncertainFloat::new(0.011_f64, 0.059_f64)),
                }),
            },
            Isotope { 
                mass_number: 91,
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    coherent_scattering_xs: Some(UncertainFloat::new(9.5_f64, 0.2_f64)),
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.15_f64, 0.04_f64)),
                    absorption_scattering_xs: Some(UncertainFloat::new(9.7_f64, 0.2_f64)),
                    thermal_absorption_xs: Some(UncertainFloat::new(1.17_f64, 0.10_f64)),
                }),
            },
            Isotope { 
                mass_number: 92,
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    b_p: None,
                    b_m: None,
                    coherent_scattering_xs: Some(UncertainFloat::new(6.9_f64, 0.4_f64)),
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.0, 0.0)),
                    absorption_scattering_xs: Some(UncertainFloat::new(6.9_f64, 0.4_f64)),
                    thermal_absorption_xs: Some(UncertainFloat::new(0.22_f64, 0.06_f64)),
                }),
            },
            Isotope { 
                mass_number: 93,
            ...
            Isotope { 
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    thermal_absorption_xs: Some(UncertainFloat::new(0.049_9_f64, 0.002_4_f64)),
                }),
            },
            Isotope { 
                mass_number: 95,
            ...
            Isotope { 
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    b_p: None,
                    b_m: None,
                    coherent_scattering_xs: Some(UncertainFloat::new(3.8_f64, 0.1_f64)),
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.0, 0.0)),
                    absorption_scattering_xs: Some(UncertainFloat::new(3.8_f64, 0.1_f64)),
                    thermal_absorption_xs: Some(UncertainFloat::new(0.022_9_f64, 0.001_0_f64)),
                }),
            },
            Isotope { 
                mass_number: 97,
