...
pub fn load() -> Element {
    Element {
        ...
        neutron_scattering: Some(NeutronScatteringFactor {
            ...
            b_p: None,
            b_m: None,
            coherent_scattering_xs: Some(UncertainFloat::new(6.32_f64, 0.04_f64)),
            incoherent_scattering_xs: Some(UncertainFloat::new(0.5_f64, 0.4_f64)),
            absorption_scattering_xs: Some(UncertainFloat::new(6.8_f64, 0.4_f64)),
            thermal_absorption_xs: Some(UncertainFloat::new(0.38_f64, 0.01_f64)),
        }),
        isotopes: vec![
            Isotope { 
                mass_number: 71,
            ...
            Isotope { 
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    b_p: None,
                    b_m: None,
                    coherent_scattering_xs: Some(UncertainFloat::new(6.2_f64, 0.2_f64)),
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.5_f64, 0.5_f64)),
                    absorption_scattering_xs: Some(UncertainFloat::new(6.7_f64, 0.5_f64)),
                    thermal_absorption_xs: Some(UncertainFloat::new(0.48_f64, 0.01_f64)),
                }),
            },
            Isotope { 
                mass_number: 86,
            ...
            Isotope { 
                ...
                neutron_scattering: Some(NeutronScatteringFactor {
                    ...
                    b_p: None,
                    b_m: None,
                    coherent_scattering_xs: Some(UncertainFloat::new(6.6_f64, 0.2_f64)),
                    incoherent_scattering_xs: Some(UncertainFloat::new(0.5_f64, 0.5_f64)),
                    absorption_scattering_xs: Some(UncertainFloat::new(7.1_f64, 0.5_f64)),
                    thermal_absorption_xs: Some(UncertainFloat::new(0.12_f64, 0.03_f64)),
                }),
            },
            Isotope { 
                mass_number: 88,
