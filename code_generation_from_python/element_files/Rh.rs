...
pub fn load() -> Element {
    Element {
        ...
        neutron_scattering: Some(NeutronScatteringFactor {
            ...
            coherent_scattering_xs: Some(UncertainFloat::new(4.34_f64, 0.06_f64)),
            incoherent_scattering_xs: Some(UncertainFloat::new(0.3_f64, 0.3_f64)),
            absorption_scattering_xs: Some(UncertainFloat::new(4.6_f64, 0.3_f64)),
            thermal_absorption_xs: Some(UncertainFloat::new(144.8_f64, 0.7_f64)),
        }),
        isotopes: vec![
            Isotope { 
                mass_number: 89,
